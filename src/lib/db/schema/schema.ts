...
// Define Database with a mapped type, enforcing BaseEntity on each table
...
export interface PersonTable extends BaseEntity {
  first_name: string
...
export interface PetTable extends BaseEntity {
  name: string
  owner_id: number
  species: 'dog' | 'cat'
}
